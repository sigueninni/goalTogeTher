...
This project is bootstraped with [Create React App](https://create-react-app.dev). It is unChlnionated with only `web3.js` as an added dependency, so nothing stands in your way.
